/*
    ...
    Write a function bestStudent() that takes any number of student objects,
    each with names for keys, and total points for values.
...
const bestStudent = (...students) => {
    ...
    let mostPointKey;
    let mostPointValue = 0;

    for (let student of students) {
        if (student.points > mostPointValue) {
            mostPointValue = student.points;
            mostPointKey = student.name;
        }
    }
    return mostPointKey;
};
